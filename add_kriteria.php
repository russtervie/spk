                        ...
                        <ul class="nav navbar-nav list-inline navbar-left">
                            ...
                            <li class="list-inline-item">
								<?php 
					  			...
					  			?>
                                <h4 class="page-title">Tambah Kriteria <?php echo $row['nama']; ?></h4>
								<?php } ?>
                            </li>
                        </ul>
                    </div><!-- end container -->
                            ...
                            <div class="col-12">
                                <div class="card-box">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="p-20">
                                                <form class="form-horizontal" role="form" method="post" action="kriteria.php?id_project=<?php echo $id_project ?>">
                                                    <div class="form-group row">
                                                        <label class="col-2 col-form-label">Nama Kriteria</label>
                                                        <div class="col-10">
                                                            <input type="text" class="form-control" placeholder="isi nama kriteria" name="kriteria" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-2 col-form-label">Nilai Kepentingan</label>
                                                        <div class="col-10">
													...
													<button type="submit" class="btn btn-success btn-rounded w-md waves-effect waves-light m-b-5" id="sa-warning">Simpan</button> 
                                                </form>
                                            </div>
                                        </div>
