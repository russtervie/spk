                        ...
                        <ul class="nav navbar-nav list-inline navbar-left">
                            ...
                            <li class="list-inline-item">
								<?php 
					  			...
					  			?>
                                <h4 class="page-title">Data <?php echo $row['nama']; ?></h4>
								<?php } ?>
                            </li>
                        </ul>
                    </div><!-- end container -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box table-responsive">
                                    <a href="add_data.php?id_project=<?php echo $id_project ?>" type="button" class="btn btn-success btn-rounded waves-effect w-md waves-light m-b-5">Add Kriteria</a><br><br>
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered">
										...
										<?php 
											$no = 0;
											$id_project   = $_GET['id_project'];
											$query = mysql_query("select * from data where id_project='$id_project'");
											while ($row = mysql_fetch_array($query)) {
											$no++;
