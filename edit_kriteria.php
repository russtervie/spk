                        ...
                        <ul class="nav navbar-nav list-inline navbar-left">
                            ...
                            <li class="list-inline-item">
								<?php 
					  			...
					  			?>
                                <h4 class="page-title">Edit Kriteria <?php echo $row['kriteria']; ?></h4>
                            </li>
                        </ul>
                    </div><!-- end container -->
                </div><!-- end navbar -->
                                            ...
                                            <div class="p-20">
                                                <form class="form-horizontal" role="form" method="post" action="kriteria.php?id_project=<?php echo $id_project ?>">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-10">
                                                            <input type="text" class="form-control" placeholder="isi nama kriteria" name="kriteria" value="<?php echo $row['kriteria']; ?>" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
													...
													<div class="form-group row">
                                                        ...
                                                        <div class="col-10">
                                                            <select class="form-control" name="bobots">
                                                                <option value="1">COST</option>
                                                                <option value="2">BENEFIT</option>
                                                            </select>
                                                        </div>
                                                    </div>
													<input type="hidden" name="id_krit" value="<?php echo $id_kriteria ?>">
