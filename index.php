						...
						<div class="row">
                            <div class="col-sm-12">
                                <div class="timeline">
                                    <article class="timeline-item alt">
                                        <div class="text-right">
                                            <div class="time-show first">
                                                <a href="project.php" class="btn btn-custom w-lg">LIST PROJECT</a>
                                            </div>
                                        </div>
                                    </article>
									<?php
									...
									$query = mysql_query("select * from logs order by waktu desc limit 10");
									while ($row = mysql_fetch_array($query)) {
									$no++;
									if (strpos($row['event'] , "menghapus") !== false)
									{
										$teks = "danger";
									}
									else 
								...
								?>
                                    <article class="timeline-item <?php echo $c; ?>">
                                        <div class="timeline-desk">
                                            <div class="panel">
                                                <div class="panel-body">
                                                    <span class="arrow-<?php echo $c; ?>"></span>
                                                    <span class="timeline-icon bg-<?php echo $teks; ?>"><i class="mdi mdi-circle"></i></span>
                                                    <h4 class="text-<?php echo $teks; ?>"><?php echo strtoupper($row['event']); ?></h4>
                                                    <p class="timeline-date text-muted"><small><?php echo $row['waktu']; ?></small></p>
                                                    <p><strong><?php echo $_SESSION["nama"]; ?></strong> telah <?php echo $row['event']; ?> <strong><?php echo $row['deskripsi']; ?></strong> </p>
                                                </div>
                                            </div>
                                        </div>
                                    </article>
